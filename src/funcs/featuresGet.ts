...
export function featuresGet(
  ...
  Result<
    operations.GetApiV1FeaturesResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetApiV1FeaturesRequest$outboundSchema.optional().parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetApiV1FeaturesResponse$inboundSchema),
